...
router.get("/categorias/:id", (req, res) => categoryController.getById(req, res));
...
/* router.get('/categorias/:estudanteId/matriculas', (req, res) => categoryController.pegaMatriculas(req, res)); */
/* router.post('/categorias/:estudanteId/matriculas', (req, res) => matriculaController.criaNovo(req, res)); */
